      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div key={item.id} className="flex flex-col sm:flex-row gap-4 p-4 border rounded-lg bg-card hover:shadow-sm transition-shadow">
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="font-bold text-lg">{item.nameEn}</h3>
        ...
        <div className="lg:col-span-1">
          <div className="bg-muted/30 p-6 rounded-lg border sticky top-24">
            <h3 className="font-bold text-xl mb-4 font-serif">Order Summary</h3>
            ...
            <div className="space-y-2 mb-6">
              ...
              <div className="border-t pt-2 mt-2 flex justify-between font-bold text-lg">
                <span>Total</span>
                <span className="text-primary">${(cartTotal + 500).toLocaleString()}</span>
              </div>
            </div>
