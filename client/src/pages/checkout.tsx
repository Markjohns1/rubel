...
export default function Checkout() {
  ...
  const onSubmit = async (data: CheckoutForm) => {
    try {
      ...
      toast({
        ...
        description: `Order #${result.order_id} placed successfully! We will contact you shortly.`,
  ...
  // WhatsApp link generator for the whole cart
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-serif font-bold mb-8">{t('checkoutTitle')}</h1>
        ...
        <div>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="address" {...register("address")} placeholder="House #, Road #, Area..." rows={4} />
